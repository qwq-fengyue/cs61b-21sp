...
public class Model extends Observable {
    ...
    private static boolean nextTileSameValue(Board b, int c, int r) {
        int margin = b.size() - 1;
        if (c < margin && b.tile(c, r).value() == b.tile(c + 1, r).value()) {
            return true;
        }
        else if (r < margin && b.tile(c, r).value() == b.tile(c, r + 1).value()) {
            return  true;
        }
